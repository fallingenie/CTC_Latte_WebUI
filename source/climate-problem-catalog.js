...
export const climateProblemSets = [
  {
    ...
    inquiry: {
      question: "미래 기후 시나리오에서 남부 지방의 비가 집중되는 시기는 우리가 알고 있던 6~7월과 다르게 나타날 수 있을까?",
      objective: "남부 지방 5개 지점의 6~10월 날짜별 강수량을 여러 기후 모델로 비교하고, 비가 집중되는 시기와 양상이 달라질 가능성을 자료에 근거해 설명한다.",
      hypothesisChoices: ["6~7월에 비가 집중될 가능성", "8월 이후에 비가 집중될 가능성", "비가 여러 시기에 나뉘어 집중될 가능성", "현재 자료만으로 판단하기 어려움"],
      interpretationLimit: "이 활동은 미래를 정확히 예측하는 것이 아니라 여러 가능성을 살펴보는 활동입니다. 하루나 한 해의 강수량만으로 장마철이 사라졌거나 시작 시기가 바뀌었다고 단정할 수 없습니다. 장마의 시작과 끝을 판단하려면 여러 해의 자료와 대기 순환 분석이 더 필요합니다."
    },
    dataPlan: {
      ...
      sites: [
        ...
        { id: "jeju", label: "제주", detail: "남쪽 섬", latitude: 33.5, longitude: 126.53 }
      ]
    },
    ...
    roles: {
      student: {
        ...
        output: ["기후 모델별 강수량 변화 그래프", "비가 집중된 기간을 정리한 표", "자료에서 찾은 근거와 판단", "주장·근거·한계가 드러나는 결론", "탐구 기록 문서와 근거 자료"]
      },
      teacher: {
  ...
  },
  {
    ...
    presentation: {
      shortLabel: "하루 기온 차이",
      title: "부산·대전·대관령의 일교차는 어떻게 다를까?",
      detail: "세 지역의 계절별 일교차 비교",
      iconKey: "temperature",
      mapTone: "school",
      tags: ["최고기온", "최저기온", "일교차"]
    },
    inquiry: {
      ...
      hypothesisChoices: ["부산의 일교차가 가장 작을 가능성", "지역 차이보다 계절 차이가 더 클 가능성", "기후 모델에 따라 지역별 순서가 달라질 가능성", "현재 자료만으로 판단하기 어려움"],
      interpretationLimit: "일교차는 각 기후 모델에서 같은 날짜의 최고기온과 최저기온으로 계산해야 합니다. 여러 모델을 종합한 최고기온과 최저기온을 단순히 빼면 정확한 값이 아닐 수 있습니다. 세 지점의 결과를 모든 해안·내륙·산지의 특징으로 일반화하지 않습니다."
    },
    dataPlan: {
    ...
    roles: {
      student: {
        ...
        output: ["월별 평균 일교차 그래프", "지역별·계절별 비교표", "기후 모델별 비교 그래프", "주장·근거·한계가 드러나는 결론"]
      },
      teacher: {
        assessmentCriteria: ["같은 날짜의 최고기온과 최저기온으로 기후 모델별 일교차를 계산한다", "지점에 따른 차이와 기후 모델에 따른 차이를 구분한다", "2060년 한 해의 결과를 장기 변화로 단정하지 않는다"]
      }
    }
  },
  {
    ...
    presentation: {
      shortLabel: "최고·최저기온",
      title: "미래 여름에는 최고기온과 최저기온 중 어느 쪽이 더 많이 변할까?",
    ...
    inquiry: {
      ...
      objective: "2041~2050년과 2081~2090년 여름의 최고기온과 최저기온을 기후 모델별로 비교하고, 두 기온의 변화 정도를 설명한다.",
    ...
    roles: {
      student: {
        prompt: "두 기간의 여름 최고기온과 최저기온 변화를 모델별로 비교하고, 어느 기온의 변화가 여러 모델에서 더 비슷하게 나타나는지 살펴보세요.",
  ...
  },
  {
    ...
    presentation: {
      ...
      title: "제주와 대관령, 계절에 따라 바람이 더 센 곳이 달라질까?",
    ...
    inquiry: {
      ...
      interpretationLimit: "이 자료에는 풍속만 있고 풍향과 대기 순환 자료는 없습니다. 풍속 자료가 없는 경우는 추정하거나 0으로 처리하지 않습니다. 두 지점의 결과를 제주와 대관령 전체의 일반적인 기후로 확대하지 않습니다."
    },
    dataPlan: {
    ...
    roles: {
      student: {
        ...
        output: ["지역별·기후 모델별 풍속 비교표", "1월·7월 풍속 막대그래프", "가설을 검토한 결과", "자료가 없는 기후 모델과 해석할 때 주의할 점"]
      },
      teacher: {
  ...
  },
  {
    ...
    presentation: {
      shortLabel: "남반구의 비",
      title: "케이프타운에서 하루 평균 강수량이 가장 많은 달은 모델마다 같을까?",
      detail: "보정 전 기후 모델 자료로 살펴본 월별 하루 평균 강수량",
      iconKey: "rain",
      mapTone: "global",
      tags: ["강수량", "남반구", "보정 전 자료"]
    },
    inquiry: {
      ...
      hypothesisChoices: ["7월의 하루 평균 강수량이 모든 모델에서 가장 많을 가능성", "6~8월의 하루 평균 강수량이 다른 달보다 많을 가능성", "하루 평균 강수량이 가장 많은 달은 모델마다 다를 가능성", "보정 전 자료만으로 판단하기 어려움"],
      interpretationLimit: "이 자료는 관측 자료로 보정하지 않은 기후 모델 자료입니다. 하루 평균 강수량과 한 달 동안 내린 비의 총량을 구분해야 합니다. 비가 내린 원인이나 특정 기상 현상을 판단하는 데 필요한 풍향, 기압, 대기 순환 자료는 없습니다."
    },
    dataPlan: {
      anchorDate: "2060-07-15",
      periodStart: "2060-01-01",
    ...
    roles: {
      ...
      teacher: {
        assessmentCriteria: ["하루 평균 강수량(mm/day)과 월 누적 강수량을 구분한다", "여러 모델을 종합한 날짜별 값과 각 모델의 월평균을 다시 평균한 값을 혼동하지 않는다", "2060년 한 해의 결과를 케이프타운의 일반적인 기후로 확대하지 않는다"]
      }
    }
  },
  {
    ...
    presentation: {
      ...
      detail: "대구의 여름철 2주간 기온·열지수·풍속·강수량 비교",
      iconKey: "heat",
      mapTone: "heat",
    ...
    dataPlan: {
      ...
      comparisonPeriods: [
        { id: "week-a", label: "첫째 주", start: "2060-08-03", end: "2060-08-09" },
        { id: "week-b", label: "둘째 주", start: "2060-08-10", end: "2060-08-16" }
      ],
      scenario: highEmissionScenario,
      defaultModel: ensembleModel,
    ...
    roles: {
      student: {
        prompt: "최고기온과 열지수가 모두 제공되는 날을 골라 두 값의 변화 폭을 비교하세요. 그런 다음 풍속과 강수량을 살펴보고, 자료로 확인한 사실과 현재 자료만으로 설명하기 어려운 원인을 구분하세요.",
        output: ["2주간 날짜별 기후 지표 그래프", "최고기온·열지수 비교표", "기후 모델별 결과 비교표", "주장·근거·한계가 드러나는 결론"]
      },
      teacher: {
        assessmentCriteria: ["평균 강수량과 누적 강수량의 뜻과 단위를 구분한다", "두 현상이 함께 나타났다는 이유만으로 원인과 결과라고 단정하지 않는다", "습도를 임의로 추정하지 않는다", "열지수가 계산되지 않은 날과 풍속 자료가 없는 모델을 따로 기록한다"]
      }
    }
  },
  {
    ...
    presentation: {
      ...
      detail: "목포의 겨울철 2주간 체감기온과 풍속 비교",
      iconKey: "cold",
      mapTone: "global",
      tags: ["체감기온", "풍속", "최고·최저기온"]
    },
    inquiry: {
      question: "목포의 겨울철 2주 동안 최고기온이 비슷한 날에도 체감기온은 다르게 나타날까? 현재 자료만으로 그 차이의 원인을 어디까지 설명할 수 있을까?",
    ...
    dataPlan: {
      ...
      comparisonPeriods: [
        { id: "week-a", label: "첫째 주", start: "2060-01-27", end: "2060-02-02" },
        { id: "week-b", label: "둘째 주", start: "2060-02-03", end: "2060-02-09" }
      ],
      scenario: highEmissionScenario,
      defaultModel: ensembleModel,
      variableKeys: ["tasmax", "tasmin", "apparentTemperature", "wind", "precipitation"],
    ...
    roles: {
      student: {
        prompt: "겨울철 2주간 기온·체감기온·풍속을 기후 모델별로 비교하세요. 먼저 체감기온 계산에 풍속이 반영된 날인지 확인하세요.",
  ...
  },
  {
    ...
    inquiry: {
      ...
      interpretationLimit: "이 열지수는 보정 전 기후 모델 자료로 계산한 참고값이며, 화면에 보정되어 표시되는 최고기온으로 다시 계산한 값이 아닙니다. 열지수는 그늘지고 바람이 약한 조건의 기온과 상대습도를 바탕으로 하므로 운동장의 햇볕이나 지면과 건물이 내뿜는 열까지 직접 나타내지는 않습니다. 고배출 경로 하나만으로 지구 온난화가 일어나는 원인을 판단할 수는 없습니다."
    },
    dataPlan: {
    ...
    roles: {
      student: {
        ...
        output: ["기후 모델별 열지수 변화 그래프", "기후 모델별 자료 제공 여부 표", "주장·근거·한계가 드러나는 결론", "야외 활동 안전 수칙 카드", "학교 안 더위 조사 계획서"]
      },
      teacher: {
  ...
  },
  {
    ...
    presentation: {
      ...
      iconKey: "heat",
      mapTone: "heat",
      tags: ["열지수", "도시 비교", "계산 요소"]
    },
    inquiry: {
      question: "세 도시의 최고기온이 비슷한 날에도 열지수 순위는 다르게 나타날까? 현재 자료만으로 그 차이의 원인을 어디까지 설명할 수 있을까?",
    ...
    roles: {
      student: {
        ...
        output: ["최고기온과 열지수 비교 그래프", "기후 모델별 자료 제공 여부 표", "추가로 필요한 자료 목록", "더위 대비 생활 안전 안내문", "탐구 기록지"]
      },
      teacher: {
  ...
  },
  {
    ...
    presentation: {
      ...
      title: "바람이 가장 센 날이 체감기온도 가장 낮을까?",
    ...
    inquiry: {
      question: "2090~2099년의 최저 체감기온은 2041~2050년보다 높게 나타날까? 바람이 가장 센 날과 체감기온이 가장 낮은 날은 항상 같을까?",
      objective: "2041~2050년과 2090~2099년 겨울의 최고·최저기온, 체감기온, 풍속을 모델별로 비교하고, 각 모델의 체감기온 계산에 어떤 자료가 쓰였는지 확인한다.",
      hypothesisChoices: ["2090~2099년의 가장 낮은 체감기온이 더 높을 가능성", "바람이 가장 센 날과 체감기온이 가장 낮은 날이 같을 가능성", "두 날짜가 기후 모델마다 다르게 나타날 가능성", "계산에 쓰인 자료가 달라 직접 비교하기 어려움"],
      interpretationLimit: "체감기온은 기온과 풍속을 함께 살펴야 하며, 바람이 세질 때마다 일정하게 낮아지는 값은 아닙니다. 풍속 자료가 없는 모델은 바람의 영향을 판단할 수 없습니다. 겨울의 체감 추위가 덜해진다고 해서 여름의 더위 위험도 줄어드는 것은 아닙니다."
    },
    dataPlan: {
    ...
    roles: {
      student: {
        prompt: "2041~2050년과 2090~2099년 겨울에서 체감기온이 가장 낮은 날과 바람이 가장 센 날을 모델별로 찾으세요. 두 날짜가 같은지 비교하기 전에 체감기온 계산에 어떤 자료가 쓰였는지 확인하세요.",
        output: ["겨울 체감기온 변화 그래프", "체감기온이 가장 낮은 날짜와 바람이 가장 센 날짜의 비교표", "기후 모델별 계산 자료 확인표", "추운 날 야외 활동 안전 안내문"]
      },
      teacher: {
        assessmentCriteria: ["체감기온을 바람의 영향만으로 정해지는 값이라고 단정하지 않는다", "계산에 쓰인 자료가 다른 모델을 구분한다", "체감기온이 가장 낮은 날짜와 바람이 가장 센 날짜를 구분한다", "겨울과 여름의 위험을 따로 해석한다", "추위에 대비하는 안전 수칙을 포함한다"]
      }
    }
  },
  {
    ...
    presentation: {
      ...
      iconKey: "global",
      mapTone: "global",
      tags: ["생각 넓히기", "사계절", "네 가지 기후 지표"]
    },
    inquiry: {
      question: "지명을 가린 두 지점의 최고·최저기온, 강수량, 풍속은 어떻게 다를까? 그 차이를 근거로 각 지점이 어느 후보에 가까운지 판단할 수 있을까?",
      objective: "아프리카 북부는 모두 덥고 건조하다는 생각을 기후 모델 자료로 검토하고, 네 가지 지표로 알 수 있는 사실과 알기 어려운 원인을 구분한다.",
      hypothesisChoices: ["사하라 내륙", "적도 우림", "지중해 해안", "아틀라스 고원 주변", "네 가지 지표만으로 판단하기 어려움"],
      interpretationLimit: "이 자료는 산 정상이나 도시 안의 특정 장소가 아니라, 사하라 내륙과 아틀라스 고원 주변에서 고른 위치의 보정 전 기후 모델 자료입니다. 네 가지 지표만으로 정확한 지명이나 차이의 원인을 확정할 수 없습니다. 풍속 자료가 없는 모델은 풍속이 0이라는 뜻이 아닙니다."
    },
    dataPlan: {
      anchorDate: "2060-07-15",
      periodStart: "2060-01-01",
      ...
      sites: [
        ...
        { id: "sahara-control", label: "사하라 내륙 지점", detail: "사하라 내륙", latitude: 30, longitude: 5 }
      ]
    },
    mystery: {
      hiddenLocation: true,
      studentSiteAliases: [
        ...
        { siteId: "sahara-control", label: "자료 B", detail: "위치 비공개" }
      ],
      choices: ["사하라 내륙", "적도 우림", "지중해 해안", "아틀라스 고원 주변"],
      hints: [
        "겨울 최저기온이 사하라 내륙 지점보다 낮게 나타납니다.",
        "여름 최고기온과 최저기온이 모두 사하라 내륙 지점보다 낮게 나타납니다.",
        "계절별 하루 평균 강수량이 사하라 내륙 지점과 다른 때가 있습니다."
      ],
      reveal: {
        answer: "아틀라스 고원 주변",
        title: "아틀라스 고원 주변의 지점",
        explanation: "두 지점의 차이에는 고도와 지형, 바다와의 거리 등이 영향을 줄 수 있습니다. 다만 이 자료만으로 어느 요인이 차이를 만들었다고 확정할 수는 없습니다."
      }
    },
    validationEvidence: {
      basis: "두 지점에서 확인한 2060년 보정 전 기후 모델 자료와 여러 모델을 종합한 값",
      atlasSummary: "아틀라스 고원 주변 지점은 사하라 내륙 지점보다 여름 최고·최저기온이 각각 약 6℃ 낮고, 겨울 최저기온도 더 낮게 나타났습니다.",
      rainSummary: "아틀라스 고원 주변 지점은 계절별 하루 평균 강수량이 0이 아닌 때가 있었지만, 사하라 내륙 지점은 겨울과 여름 모두 0에 가까웠습니다.",
    ...
    roles: {
      student: {
        prompt: "지명이 가려진 자료 A와 B의 월별 네 지표를 비교하세요. 각 후보가 아닌 근거를 찾아 후보를 하나씩 제외하고, 위치를 확인한 뒤 처음 생각이 어떻게 바뀌었는지 설명하세요.",
        output: ["후보가 아닌 근거를 정리한 표", "계절별 네 가지 기후 지표 그래프", "두 지점 비교표", "주장·근거·한계가 드러나는 문단", "생각이 바뀐 과정"]
      },
      teacher: {
        assessmentCriteria: ["아프리카를 하나의 기후로 일반화하지 않는다", "고원 주변에서 고른 위치의 값과 산 정상의 관측값을 구분한다", "풍속 자료가 없는 모델을 풍속 0으로 처리하지 않는다", "네 가지 지표만으로 원인을 확정하지 않는다", "정답보다 후보를 제외한 근거와 해석의 한계를 평가한다"]
      }
    }
  }
];
