import{J as m}from"./archive-vendor-_nnzlRcC.js";import"./react-vendor-Bj2qpdZ1.js";const c="기후 타임캡슐 문서";function g(t){return String(t??"").replace(/&#x([0-9a-f]+);/giu,(e,r)=>String.fromCodePoint(Number.parseInt(r,16))).replace(/&#([0-9]+);/gu,(e,r)=>String.fromCodePoint(Number.parseInt(r,10))).replace(/&lt;/gu,"<").replace(/&gt;/gu,">").replace(/&quot;/gu,'"').replace(/&apos;/gu,"'").replace(/&amp;/gu,"&")}function l(t){return String(t??"").replace(/&/gu,"&amp;").replace(/</gu,"&lt;").replace(/>/gu,"&gt;").replace(/"/gu,"&quot;").replace(/'/gu,"&#39;")}function s(t){const e=[],r=/<w:t(?:\s[^>]*)?>([\s\S]*?)<\/w:t>|<w:(tab|br)\b[^>]*\/?\s*>/gu;for(const o of String(t??"").matchAll(r))o[1]!==void 0?e.push(g(o[1])):e.push(o[2]==="tab"?"	":`
